...
class Game(object):
    ...
    def play(self, player1: Player, player2: Player, interactive = 0) -> int:
        ...
        if interactive == 2 or interactive == 1:
            print(f'Game finished in: {tot_moves} moves')
